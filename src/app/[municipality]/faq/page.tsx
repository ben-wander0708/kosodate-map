...
export async function generateMetadata({ params }: FaqPageProps): Promise<Metadata> {
  ...
  return {
    title: `よくある質問｜${name}の子育て情報｜総社子育てノート`,
...
const FAQ_ITEMS = [
  {
    ...
    answer: "総社子育てノートでは住所が決まった段階から保育園の空き状況・場所・特徴を確認できます。入園申込みの手続きや必要書類・時期については、総社市こども夢づくり課に直接ご確認ください。https://www.city.soja.okayama.jp/kodomo_yumedukuri/sisei_kodomo_yume/kodomo_yume.html"
  },
  {
    question: "保育園の空き状況の「○△×」はどういう意味ですか？",
    answer: "総社子育てノート上では、○は空きあり、△は若干空きあり（要確認）、×は空きなしを表しています。表示データは令和7年1月時点の情報をもとにしており、実際の空き状況とは異なる場合があります。最新情報は各保育園または市役所に直接ご確認ください。"
  },
  {
    question: "認可保育施設と認可外保育施設の違いは何ですか？",
    answer: "認可保育施設は国が定めた基準を満たした施設で、保育料は世帯収入に応じて市区町村が決定します。認可外保育施設は国の認可を受けていない施設で、保育料や運営方法は施設ごとに異なります。総社子育てノートでは主に認可保育所・認定こども園・小規模保育の情報を掲載しています。"
  },
  {
    question: "転入後の保育園申込みはどこに相談すればいいですか？",
    answer: "総社市こども夢づくり課が窓口です。申込み時期・必要書類・保育料の計算方法など、入園に関する正式な情報はすべて市役所にご確認ください。総社子育てノートはあくまで施設の場所・特徴・空き状況を事前に把握するためのツールです。https://www.city.soja.okayama.jp/kodomo_yumedukuri/sisei_kodomo_yume/kodomo_yume.html"
  },
  {
    question: "総社子育てノートのデータはいつ更新されますか？",
  ...
  {
    question: "総社子育てノートに掲載されている行政支援の情報はどこから来ていますか？",
